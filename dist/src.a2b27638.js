...
let e,
  ...
  o = () => e || s() && (e = window.gsap) && e.registerPlugin && e,
  a = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
  d = {
    rect: ["width", "height"],
    circle: ["r", "r"],
  ...
  l = e => Math.round(1e4 * e) / 1e4,
  h = e => parseFloat(e) || 0,
  f = (e, t) => {
    let n = h(e);
    return ~e.indexOf("%") ? n / 100 * t : n;
  },
  g = (e, t) => h(e.getAttribute(t)),
  u = Math.sqrt,
  c = (e, t, n, i, r, s) => u(((h(n) - h(e)) * r) ** 2 + ((h(i) - h(t)) * s) ** 2),
  p = e => console.warn(e),
  w = e => "non-scaling-stroke" === e.getAttribute("vector-effect"),
  _ = function () {
    return String.fromCharCode.apply(null, arguments);
  },
  y = _(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
  x = function (e) {
    var t = "undefined" != typeof window,
      n = 0 === (t ? window.location.href : "").indexOf(_(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(_(108, 111, 99, 97, 108, 104, 111, 115, 116)) || -1 !== e.indexOf(_(49, 50, 55, 46, 48, 32, 48, 46, 49)),
  ...
  m = e => {
    ...
    let n,
      ...
      y = 1,
      x = 1;
    w(e) && (x = e.getScreenCTM(), y = u(x.a * x.a + x.b * x.b), x = u(x.d * x.d + x.c * x.c));
    try {
      i = e.getBBox();
    } catch (e) {
      p("Some browsers won't measure invisible elements (like display:none or masks inside defs).");
    }
    let {
      x: m,
      y: b,
  ...
  b = (e, i) => {
    ...
    let r = n.getComputedStyle(e),
      s = r.strokeDasharray || "",
      o = h(r.strokeDashoffset),
      a = s.indexOf(",");
    return a < 0 && (a = s.indexOf(" ")), s = a < 0 ? i : h(s.substr(0, a)), s > i && (s = i), [-o || 0, s - o || 0];
  },
  k = () => {
    s() && (n = window, r = e = o(), t = e.utils.toArray, i = -1 !== ((n.navigator || {}).userAgent || "").indexOf("Edge"));
  };
const v = {
  version: "3.10.2",
  name: "drawSVG",
  ...
  init(e, t, s, o, a) {
    ...
    let d,
      ...
      u,
      c = m(e);
    return this._style = e.style, this._target = e, t + "" == "true" ? t = "0 100%" : t ? -1 === (t + "").indexOf(" ") && (t = "0 " + t) : t = "0 0", d = b(e, c), g = ((e, t, n) => {
      let i,
        r,
        s = e.indexOf(" ");
      return s < 0 ? (i = void 0 !== n ? n + "" : e, r = e) : (i = e.substr(0, s), r = e.substr(s + 1)), i = f(i, t), r = f(r, t), i > r ? [r, i] : [i, r];
  ...
  render(e, t) {
    let n,
      ...
      a = t._style;
    if (o) {
      for (t._live && (n = m(t._target), n !== t._length && (i = n / t._length, t._length = n, t._offsetPT && (t._offsetPT.s *= i, t._offsetPT.c *= i), t._dashPT ? (t._dashPT.s *= i, t._dashPT.c *= i) : t._dash *= i)); o;) o.r(e, o.d), o = o._next;
...
exports.DrawSVGPlugin = v;
o() && e.registerPlugin(v);
var _default = v;
exports.default = _default;
...
let X,
  ...
  nt = (t, e) => {
    ...
    })(t), o = -l.e / l.a, s = -l.f / l.d, r = Z) : (l = t.getBBox(), r = t.transform ? t.transform.baseVal : {}, r = r.numberOfItems ? r.numberOfItems > 1 ? (t => {
      let e = new lt(),
        n = 0;
      for (; n < t.numberOfItems; n++) e.multiply(t.getItem(n).matrix);
      return e;
    })(r) : r.getItem(0).matrix : Z, o = r.a * l.x + r.c * l.y, s = r.b * l.x + r.d * l.y), e && "g" === t.tagName.toLowerCase() && (o = s = 0), (h ? a : p).appendChild(n), n.setAttribute("transform", "matrix(" + r.a + "," + r.b + "," + r.c + "," + r.d + "," + (r.e + o) + "," + (r.f + s) + ")");else {
...
function draw(el) {
  var tl = _gsapTrial.default.timeline({
    paused: true
  });
  tl.to(el, {
    drawSVG: true,
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40045" + '/');
